...
final class ColocatedEventLoopGroup implements EventLoopGroup, Supplier<EventLoopGroup> {
	...
	private static final Logger log = LoggerFactory.getLogger(ColocatedEventLoopGroup.class);
	...
	public EventLoop next() {
		if (localLoop.isSet()) {
			log.info("Got a EventLoop, from FastThreadLocal<EventLoop> localLoop");
